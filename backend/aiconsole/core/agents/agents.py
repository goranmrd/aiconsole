...
class Agents:
    ...
    def __init__(self):
        ...
        os.makedirs(get_project_agents_directory(), exist_ok=True)
        self.observer.schedule(
            BatchingWatchDogHandler(self.reload), get_project_agents_directory(), recursive=True
        )
        self.observer.start()
    ...
    async def reload(self):
        ...
        paths = [
            ...
            for paths_yielding_function in [
                list_files_in_file_system(get_core_agents_directory()),
                list_files_in_file_system(get_project_agents_directory()),
            ]
