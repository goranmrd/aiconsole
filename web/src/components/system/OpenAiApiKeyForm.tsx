...
const OpenAiApiKeyForm = () => {
  ...
  return (
    <div className="flex items-center flex-col min-h-[100vh] px-[60px]">
      <div className="pt-[120px] z-50">
        ...
        <p className="mt-10 mb-4 text-lg text-center font-semibold text-white">To proceed, enter your OpenAI API key.</p>
